...
<header>
	<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="<?php echo base_url('Welcome/club_admin'); ?>">Club Admin Panel</a>
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav me-auto mb-2 mb-md-0">
					...
					<li class="nav-item">
						<a class="nav-link" href="<?php echo base_url('Welcome/leaderboard'); ?>">Leaderboards</a>
					</li>
				</ul>
				<div class="d-flex">
					<button class="btn btn-outline-danger"
							onclick="window.location.href = '<?php echo base_url('Auth/logout'); ?>'">Logout
					</button>
				</div>
			</div>
		</div>
