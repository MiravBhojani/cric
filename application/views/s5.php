	...
	<div class="container">
		<div class="card mt-4">
			<div class="card-header">
				<h3>Second Bowling - <?php echo ucfirst($club_name); ?></h3>
			</div>
			<div class="card-body">
				<form action="<?= base_url('Welcome/leaderboard') ?>" method="post">
					<div class="mb-3">
						<table class="table table-striped">
							...
							<?php foreach ($players as $player) : ?>
								<tr>
									...
									<td>
										<input type="number" class="form-control" name="wickets_taken_<?= $player['player_id'] ?>"
					...
					<input type="hidden" name="s1_id" value="<?= $s1_id ?>"/>
